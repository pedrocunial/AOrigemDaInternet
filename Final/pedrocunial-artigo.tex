...
% in the abstract
\begin{abstract}
	Este artigo busca descrever o processo da criação da Internet em seu
  primórdio, almejando compreender o motivo dos formatos atuais pelos quais
  compartilhamos dados pela óptica das telecomunicações e política. Explorando
  temáticas sobre RFC, modelo TCP/IP e a história pré, pós e durante a ARPANET.
\end{abstract}
\end{document}
% no keyword
